...
async function initStationPlatformLayouts(){
  ...
  [
    ...
    "Spoor 1: noordzijde (niet over de volledige lengte)."
  ],
  [
    "arnhem",
    "Arnhem Centraal",
  ...
  [
    ...
    "Sporen 49/50 horen fysiek bij de westelijke verlenging van het perron van 9/10. Sporen 21–24: ondergrondse kopsporen."
  ],
  [
    "basel-sbb",
    "Basel SBB",
    ...
    "De Franse treinen vertrekken in een apart gedeelte: sporen 30–31 en 33–35."
  ],
  [
    "spiez",
    "Spiez",
  ...
  [
    ...
    "Sporen 1–4 liggen bij elkaar en zijn kopsporen."
  ],
  [
    "hengelo",
    "Hengelo",
    ...
    "Spoor 11 is een zak-/kopspoor dat in het eilandperron van 2/3 eindigt. Vanuit 11 hoef je niet via de tunnel naar 2/3; het is niet simpelweg de andere kant van het perron."
  ],
  [
    "arth-goldau",
    "Arth-Goldau",
  ...
  [
    ...
    "Sporen 1–8 liggen beneden (tief); sporen 11–16 liggen op het bovenste niveau."
  ],
  [
    "hamburg",
    "Hamburg Hbf",
    ...
    "Sporen 1/2: ondergrondse S-Bahn. Sporen 3/4: S-Bahn in de stationshal."
  ],
  [
    "koeln",
    "Köln Hbf",
  ...
  for(const [key,name,groups,notes] of suppliedLayouts){
    const values=[key,name,JSON.stringify(groups),'Opgegeven door gebruiker in projectgesprek','user_supplied',Date.now(),notes];
    if(backend==='postgresql'){
      await pool.query('INSERT INTO station_platform_layouts(station_key,station_name,platform_groups,source,verification_status,recorded_at,notes) VALUES($1,$2,$3,$4,$5,$6,$7) ON CONFLICT(station_key) DO NOTHING',values);
    }else{
