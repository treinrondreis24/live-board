import {boardRows,shortCity,statusView} from './connections-view.js';
...
function render(){
 ...
 $('pages').textContent=all.length?`${page+1} / ${total}`:'';
