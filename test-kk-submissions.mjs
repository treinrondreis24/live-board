...
try{
 ...
 const proof=await saveSubmission(a,{id:randomUUID(),kind:'proof',text:'Utrecht Centraal',station:'Utrecht Centraal',stationId:'nl-ut',receivedAt:1,createdAt:1});assert.equal(proof.stationId,'nl-ut');assert.ok(proof.receivedAt>1);assert.ok(proof.createdAt>1);
