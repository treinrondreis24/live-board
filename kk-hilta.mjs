...
import {calculateTestRoute,testStations,assertTestConfirmable} from './hilta-next/test-edition.mjs';
...
const stationAliases=new Map([['eindhoven','Eindhoven Centraal'],['rotterdam c','Rotterdam Centraal'],['den haag hs','Den Haag Hollands Spoor'],['schiphol airport','Schiphol'],['breda-prinsenbeek','Breda Prinsenbeek'],['alphen a/d rijn','Alphen aan den Rijn'],['den haag laan v noi','Den Haag Laan van NOI']]);
...
export function calculateHilta(from,to,via=[],choices={}){
 ...
 if(testEdition())return {...calculateTestRoute(from,to,via,choices),notice:hiltaNotice};
